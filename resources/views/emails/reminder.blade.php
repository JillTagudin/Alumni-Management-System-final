    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            @if(isset($actionUrl) && isset($actionText))
                <div style="text-align: center; margin: 30px 0;">
                    <a href="{{ $actionUrl }}" style="display: inline-block; background-color: #f39c12; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px;">{{ $actionText }}</a>
                </div>
            @endif
        </div>
        ...
        <div class="social-sharing">
            ...
            <div class="social-buttons">
                @php
                    $shareUrl = url('/');
                    $shareText = urlencode($subject ?? 'Check out this reminder');
                @endphp
        ...
        <div class="footer">
            <p>This reminder was sent from the Alumni Management System.</p>
